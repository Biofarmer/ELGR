...
rgi_adonis_strata <- read.csv("data/rgi_covar_contri_adonis_strata_50.csv")
...
write.table(subtype_covar_contri_cb, file = "~/Desktop/work/preterm/analysis/revision/figure/covariate/subtype_covar_contri_cb.csv",row.names = F,sep = ",")
